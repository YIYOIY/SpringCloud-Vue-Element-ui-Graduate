    ...
    <el-form label-position="top" ref="form" :model="user.user" :rules="rule">
      ...
      <div style="left: 2%;width:35%;height:20%;position: relative">
        <el-form-item label="账户名称" prop="userName">
          <el-input v-model="user.user.userName" autofocus @change="next" maxlength="20" minlength="1" clearable
        ...
        <el-form-item label="联系方式" prop="userPhone">
          <el-input v-model.number="user.user.userPhone" clearable maxlength="11" @change="next"
    ...
    <div style="right: 2%;width: 50%;top:5%;position: absolute">
      <el-row>
        ...
        <el-row  v-show="havePicture">
          <el-col :span="24">
            <el-image style="width: 780px; height: 580px;margin-top: 5%;z-index: 2" :src="user.user.image.picture" fit="contain" v-show="havePicture"/>
          </el-col>
